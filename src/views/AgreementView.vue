  ...
  <main role="main">
    <section class="py-6 px-2 w-full">
      <div class="px-1">
        ...
        <p class="text-xl font-bold">1.账号注册</p>
        <p class="">
          <strong></strong>乙方承诺以其真实身份注册成为甲方的用户，并保证所提供的个人身份资料信息真实、完整、有效，依据法律规定和必备条款约定对所提供的信息承担相应的法律责任。
        </p>
        <p class="">
          <strong></strong>乙方以其真实身份注册成为甲方用户后，需要修改所提供的个人身份资料信息的，甲方应当及时、有效地为其提供该项服务。
        </p>
        <p class="text-xl font-bold">2.用户账号使用与保管</p>
        <p class="">
          2.1
        ...
        <p class="">
          2.3
          乙方发现其账号或密码被他人非法使用或有使用异常的情况的，应及时根据甲方公布的处理方式通知甲方，并有权通知甲方采取措施暂停该账号的登录和使用。
        </p>
        <p class="">
          2.4
        ...
        <p class="">
          2.4.1
          甲方核实乙方所提供的个人有效身份信息与所注册的身份信息相一致的，应当及时采取措施暂停乙方账号的登录和使用。
        </p>
        <p class="">
          2.4.2
        ...
        <p class="">
          2.4.3
          乙方没有提供其个人有效身份证件或者乙方提供的个人有效身份证件与所注册的身份信息不一致的，甲方有权拒绝乙方上述请求。
        </p>
        <p class="">
          2.5
        ...
        <p class="text-xl font-bold">3.服务的中止与终止</p>
        <p class="">
        ...
        <p class="">
          3.4
          甲方根据本条约定中止或终止对乙方提供部分或全部服务的，甲方应负举证责任。
        </p>
        <p class="text-xl font-bold">4.用户信息保护</p>
        <p class="">
          4.1
        ...
        <p class="">4.2.1 乙方或乙方监护人授权甲方披露的</p>
        <p class="">4.2.2 有关法律要求甲方披露的；</p>
        <p class="">4.2.3 司法机关或行政机关基于法定程序要求甲方提供的；</p>
        <p class="">
          4.2.4 甲方为了维护自己合法权益而向乙方提起诉讼或者仲裁时；
        </p>
        <p class="">4.2.5 应乙方监护人的合法要求而提供乙方个人身份信息时。</p>
      </div>
    </section>
  </main>
</template>
